  ...
  return (
    <div className="bg-white rounded-xl border border-gray-200 divide-y divide-gray-100">
      <div className="px-6 py-5">
        <h1 className="text-xl font-semibold text-gray-900">Тохиргоо</h1>
      </div>

      {/* Language / Currency */}
      <div className="px-6 py-5">
        <h2 className="text-sm font-semibold text-gray-700 mb-4">Хэл / Валют</h2>
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">Валют</span>
            <span className="text-sm text-gray-500">MNT / ₮</span>
          </div>
          <div className="flex items-center justify-between">
            <span className="text-sm text-gray-600">Хэл</span>
            <div className="relative">
              <select
                value={language}
                onChange={(e) => setLanguage(e.target.value)}
                className="text-sm text-gray-800 border border-gray-300 rounded-lg px-3 py-1.5 pr-7 appearance-none bg-white focus:ring-2 focus:ring-blue-500 outline-none transition"
              >
                {LANGUAGES.map((l) => (
      ...
      {/* Email settings */}
      <div className="px-6 py-5">
        <h2 className="text-sm font-semibold text-gray-700 mb-4">И-мэйл тохиргоо</h2>
        <div className="space-y-4">
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm text-gray-800">Захиалга баталгаажсан и-мэйл</p>
              <p className="text-xs text-gray-400 mt-0.5">Захиалга баталгаажсаны дараах и-мэйлийг идэвхгүй болгох боломжгүй.</p>
            </div>
            <Toggle checked={bookingConfirmEmail} onChange={setBookingConfirmEmail} />
          </div>
          <div className="flex items-start justify-between gap-4">
            <div>
              <p className="text-sm text-gray-800">Үнэлгээний и-мэйл</p>
              <p className="text-xs text-gray-400 mt-0.5">Таны захиалга биелэж дууссаны дараа тухайн буудалд үнэлгээ өгч, сэтгэгдэл үлдээх и-мэйл явуулах</p>
            </div>
      ...
      {/* Notifications */}
      <div className="px-6 py-5">
        <h2 className="text-sm font-semibold text-gray-700 mb-4">Мэдэгдэл</h2>
        <div className="flex items-start justify-between gap-4">
      ...
      {/* Delete account */}
      <div className="px-6 py-5">
        <h2 className="text-sm font-semibold text-gray-700 mb-2">Бүртгэл устгах</h2>
