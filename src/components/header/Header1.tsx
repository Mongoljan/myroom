...
const Header1 = () => {
  ...
  return (
    <>
      <header className="relative z-50 bg-white dark:bg-gray-800 shadow-lg border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center">
              ...
              <div className="hidden md:flex items-center space-x-3">
                {isAuthenticated && user ? (
                  ...
                  <Link
                    href="/login"
                    className={`px-4 h-10 bg-primary hover:bg-primary-600 text-white rounded-lg transition-all duration-200 shadow-sm hover:shadow-md ${TYPOGRAPHY.button.standard} font-medium flex items-center`}
                  >
