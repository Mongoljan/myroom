...
export default function AceternityHero() {
  ...
  return (
    <section className="relative min-h-[450px] py-8 overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(59,150,232,0.1),transparent_50%)]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <PointerHighlight highlightColor="rgba(59, 150, 232, 0.15)">
          <motion.div
