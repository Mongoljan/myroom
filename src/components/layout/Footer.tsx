          ...
          <div className="md:col-span-1 flex flex-col gap-4">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-slate-300">
                <a href="tel:90234234" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Phone className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                  90234234
                </a>
                <a href="tel:75758595" className="flex items-center gap-2 hover:text-white transition-colors">
                  <Phone className="w-3.5 h-3.5 text-slate-400 shrink-0" />
                  75758595
                </a>
            ...
            <div className="flex items-center gap-3 mt-1">
              {/* Facebook */}
              <a href="https://www.facebook.com/profile.php?id=61579682037246" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/myroom.mn/" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-white transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
