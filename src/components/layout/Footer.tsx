        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 lg:col-span-1">
            ...
            <div className="space-y-4">
              <h4 className={`${TYPOGRAPHY.heading.h3} mb-4 text-slate-300`}>{t('footer.contactUs', 'ХОЛБОО БАРИХ').toUpperCase()}</h4>

              <div className="flex items-center space-x-3">
                <Phone className="w-5 h-5 text-slate-300" />
                <a href="tel:+97699972626" className={`${TYPOGRAPHY.body.standard} text-slate-200 hover:text-slate-100 transition-colors cursor-pointer`}>
                  +976-9997-2626
                </a>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@myroom.mn" className={`${TYPOGRAPHY.body.standard} text-slate-200 hover:text-slate-100 transition-colors cursor-pointer`}>
                  info@myroom.mn
                </a>
              </div>

              <div className="flex items-start space-x-3">
                <MapPin className="w-5 h-5 text-slate-300 mt-0.5 flex-shrink-0" />
          ...
          {/* БИДНИЙ ТУХАЙ */}
          <div>
            <h4 className={`${TYPOGRAPHY.heading.h3} mb-6 text-slate-300`}>БИДНИЙ ТУХАЙ</h4>
            <ul className="space-y-3">
              <li><Link href="/about" className={`${TYPOGRAPHY.body.standard} text-slate-200 hover:text-slate-100 transition-colors`}>Танилцуулга</Link></li>
              <li><Link href="/terms" className={`${TYPOGRAPHY.body.standard} text-slate-200 hover:text-slate-100 transition-colors`}>Үйлчилгээний нөхцөл</Link></li>
              <li><Link href="/privacy" className={`${TYPOGRAPHY.body.standard} text-slate-200 hover:text-slate-100 transition-colors`}>Нууцлалын бодлого</Link></li>
              <li><Link href="/logo-download" className={`${TYPOGRAPHY.body.standard} text-slate-200 hover:text-slate-100 transition-colors`}>Лого татаж авах</Link></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-3">
                <Link href="#" className="w-10 h-10 bg-gray-700 hover:bg-slate-900 rounded-full flex items-center justify-center transition-colors">
