    ...
    <div className="bg-white rounded-xl border border-gray-200 p-16 text-center">
      <div className="max-w-lg mx-auto">
        <div className="relative mb-8">
          ...
          <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-32 h-32 bg-slate-50 rounded-full -z-10 animate-pulse"></div>
        </div>
          ...
          <div className="pt-4 border-t border-gray-200">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              {[
                ...
                <button
                  key={city}
                  className="px-3 py-1.5 text-sm bg-gray-100 text-gray-900 rounded-full hover:bg-gray-200 hover:underline transition-all"
                  onClick={() => {
