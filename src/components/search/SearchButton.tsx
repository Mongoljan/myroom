  ...
  return (
    <div className="p-4">
      <motion.button
        ...
        className="px-4 py-2.5 rounded-lg transition-all duration-200 flex items-center justify-center gap-2 font-medium text-sm bg-secondary hover:bg-secondary/90 text-white"
      >
