                  ...
                  <div className="w-full sm:w-[240px] flex flex-col gap-4 shrink-0">
                    ...
                    <div className="flex flex-col gap-3 text-sm text-gray-500 mt-2">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="truncate">Standard King Өрөө</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <Calendar className="w-4 h-4 shrink-0" />
                        <span className="truncate">2025/05 сард захиалсан</span>
                      </div>
                      <div className="flex items-center gap-3">
                        <Briefcase className="w-4 h-4 shrink-0" />
                        <span className="truncate">Бизнес аялалаар</span>
                      </div>
                    </div>
                  </div>
