...
export default function HotelLocationInfo({ 
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      {location && (
        <div className="flex items-start gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
      ...
      {provinceCity && (
        <div className="flex items-start gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
          ...
          <div>
            ...
            <div className="text-gray-900 dark:text-white font-medium">{provinceCity}</div>
          </div>
        </div>
      )}
      ...
      {soumDistrict && (
        <div className="flex items-start gap-3 p-4 rounded-lg bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
          ...
          <div>
            ...
            <div className="text-gray-900 dark:text-white font-medium">{soumDistrict}</div>
          </div>
        </div>
      )}
