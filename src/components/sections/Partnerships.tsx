          ...
          <div className="relative overflow-hidden">
            <div className="flex partnership-scroll whitespace-nowrap">
              ...
              {partners.map((partner, idx) => (
                <div key={`first-${idx}`} className="flex-shrink-0 mx-8 flex items-center justify-center h-16 w-36">
                  <Image
                    src={partner.logo}
                    alt={partner.name}
                    width={140}
              ...
              {partners.map((partner, idx) => (
                <div key={`second-${idx}`} className="flex-shrink-0 mx-8 flex items-center justify-center h-16 w-36">
                  <Image
                    src={partner.logo}
                    alt={partner.name}
                    width={140}
