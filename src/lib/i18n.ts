  ...
  en: {
    translation: {
      ...
      footer: {
        ...
        address: "Khan-Uul district, 15th khoroo, Chinggis Avenue street, 33/2-1508, Ulaanbaatar, Mongolia",
        ...
        copyright: "© 2025 MyRoom. All rights reserved.",
        ...
        roomManagementSystem: "Room Management System",
      ...
      settings: {
        ...
        deleteModal: {
          blockedTitle: "Cannot delete account.",
          blockedDesc: "You have active bookings. You can delete your account after they are completed or cancelled.",
          close: "Close",
          confirmTitle: "Delete Account",
          confirmDesc: "Please enter your password to confirm account deletion.",
          passwordLabel: "Password",
          ...
          successClose: "Close",
          checkingBookings: "Checking bookings..."
        },
        languages: {
          mn: "Mongolian",
          en: "English",
      ...
      bookingExtra: {
        ...
        roomTypeCol: "Room",
        extraDescCol: "Extra description",
        originalRoom: "Original booking",
        addedRoom: "Added room",
        addedRoomsSection: "Added rooms",
        additionalBookingSection: "Additional booking",
        ...
        printBookingPage: "Print booking page",
        downloadBookingPage: "Download booking page",
  ...
  mn: {
    translation: {
      ...
      footer: {
        ...
        copyright: "© 2025 MyRoom. Бүх эрх хуулиар хамгаалагдсан.",
        introduction: "Танилцуулга",
        downloadLogo: "Лого татаж авах",
        instructions: "Заавар",
        information: "Мэдээлэл",
        faq: "Түгээмэл асуулт, хариулт",
        feedback: "Санал, хүсэлт",
        partnership: "Хамтран ажиллах",
        roomManagementSystem: "Өрөө удирдлагын систем",
        partnerLogin: "Бүртгүүлэх / Нэвтрэх",
        downloadOnThe: "App Store-оос татах",
        getItOn: "Google Play-ээс татах"
      },
      home: {
      ...
      reviews: {
        ...
        rateExperience: "Үнэлгээ өгөх",
        overallRating: "Та үнэлгээгээ өгнө үү",
        stars: "од",
      ...
      settings: {
        ...
        autoSaved: "Хадгалагдлаа",
        autoSaving: "Хадгалж байна...",
        autoSaveError: "Хадгалахад алдаа гарлаа",
        deleteModal: {
          blockedTitle: "Бүртгэл устгах боломжгүй байна.",
          blockedDesc: "Таны бүртгэл дээр идэвхтэй захиалга байгаа тул та захиалгыг биелэх эсвэл цуцалсны дараа устгах боломжтой",
          close: "Хаах",
          confirmTitle: "Бүртгэл устгах",
          confirmDesc: "Та нууц үгээ хийж баталгаажуулан, бүртгэлээ устгана уу.",
          passwordLabel: "Нууц үг",
          passwordPlaceholder: "Нууц үгээ оруулна уу",
          cancelButton: "Үгүй, хэвээр үлдээх",
          confirmButton: "Баталгаажуулах",
          successTitle: "Амжилттай устгадлаа.",
          successClose: "Хаах",
          checkingBookings: "Захиалга шалгаж байна..."
        },
        languages: {
          mn: "Монгол",
          en: "English",
      ...
      hotel: {
        ...
        reviewsSection: {
          ...
          showAll: "Бүх {{count}}-н сэтгэгдэл харах",
      ...
      search: {
        ...
        propertyTypeLabel: "Төрлөөр ангилах",
        checkIn: "Ирэх өдөр",
        checkOut: "Явах өдөр",
        guest: "Зочин",
        guests: "Зочид",
      ...
      bookingExtra: {
        ...
        originalRoom: "Анхны захиалга",
        addedRoom: "Нэмсэн өрөө",
        addedRoomsSection: "Нэмсэн өрөөнүүд",
        additionalBookingSection: "Нэмэлт захиалга",
        ...
        print: "Хэвлэх",
        downloadPDF: "Татах",
        printBookingPage: "Захиалгын хуудас хэвлэх",
        downloadBookingPage: "Захиалгын хуудас татах",
        backHome: "Буцах",
        checkIn: "Орох",
        checkOut: "Гарах",
        night: "шөнө",
      ...
      profileBookings: {
        ...
        deleteSuccess: "Захиалга амжилттай устгагдлаа.",
        deleting: "Устгаж байна...",
        roomsCount: "{{count}} өрөө",
        roomAdded: "Өрөө нэмсэн",
  ...
  zh: {
    translation: {
      ...
      settings: {
        ...
        deleteModal: {
          blockedTitle: "无法删除账户。",
          blockedDesc: "您有进行中的预订。请在预订完成或取消后再删除账户。",
          close: "关闭",
          confirmTitle: "删除账户",
          confirmDesc: "请输入您的密码以确认删除账户。",
          passwordLabel: "密码",
          passwordPlaceholder: "请输入密码",
          cancelButton: "取消，保留账户",
          confirmButton: "确认",
          successTitle: "已成功删除。",
          successClose: "关闭",
          checkingBookings: "正在检查预订..."
        },
